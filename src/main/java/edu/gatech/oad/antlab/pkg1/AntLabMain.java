...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Maria Shapiro");
        toPrint += p1.toString("mshapiro9");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Anshul Agrawal");
        toPrint += p2.toString("aagrawal324");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Stephen Zacks");
        toPrint += p3.toString("szacks3");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("John Robinson");
        toPrint += p4.toString("jrobinson339");
